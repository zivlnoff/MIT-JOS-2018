...
sys_ipc_recv(void *dstva)
{
  ...
  8002f0:	68 ca 0f 80 00       	push   $0x800fca
  8002f5:	6a 24                	push   $0x24
  8002f7:	68 e7 0f 80 00       	push   $0x800fe7
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800485:	0f be 80 1e 10 80 00 	movsbl 0x80101e(%eax),%eax
  80048c:	50                   	push   %eax
...
008004d9 <vprintfmt>:
{
  ...
  8005fc:	52                   	push   %edx
  8005fd:	68 3f 10 80 00       	push   $0x80103f
  800602:	53                   	push   %ebx
  800603:	56                   	push   %esi
  ...
  800614:	50                   	push   %eax
  800615:	68 36 10 80 00       	push   $0x801036
  80061a:	53                   	push   %ebx
  80061b:	56                   	push   %esi
  ...
  80063c:	b8 2f 10 80 00       	mov    $0x80102f,%eax
