...
sys_env_destroy(envid_t envid) {
  ...
  8000ff:	68 cf 0f 80 00       	push   $0x800fcf
  800104:	6a 24                	push   $0x24
  800106:	68 ec 0f 80 00       	push   $0x800fec
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800180:	68 cf 0f 80 00       	push   $0x800fcf
  800185:	6a 24                	push   $0x24
  800187:	68 ec 0f 80 00       	push   $0x800fec
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001c2:	68 cf 0f 80 00       	push   $0x800fcf
  8001c7:	6a 24                	push   $0x24
  8001c9:	68 ec 0f 80 00       	push   $0x800fec
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800204:	68 cf 0f 80 00       	push   $0x800fcf
  800209:	6a 24                	push   $0x24
  80020b:	68 ec 0f 80 00       	push   $0x800fec
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800246:	68 cf 0f 80 00       	push   $0x800fcf
  80024b:	6a 24                	push   $0x24
  80024d:	68 ec 0f 80 00       	push   $0x800fec
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800288:	68 cf 0f 80 00       	push   $0x800fcf
  80028d:	6a 24                	push   $0x24
  80028f:	68 ec 0f 80 00       	push   $0x800fec
...
sys_ipc_recv(void *dstva)
{
  ...
  8002ec:	68 cf 0f 80 00       	push   $0x800fcf
  8002f1:	6a 24                	push   $0x24
  8002f3:	68 ec 0f 80 00       	push   $0x800fec
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800481:	0f be 80 22 10 80 00 	movsbl 0x801022(%eax),%eax
  800488:	50                   	push   %eax
...
008004d5 <vprintfmt>:
{
  ...
  8005f8:	52                   	push   %edx
  8005f9:	68 43 10 80 00       	push   $0x801043
  8005fe:	53                   	push   %ebx
  8005ff:	56                   	push   %esi
  ...
  800610:	50                   	push   %eax
  800611:	68 3a 10 80 00       	push   $0x80103a
  800616:	53                   	push   %ebx
  800617:	56                   	push   %esi
  ...
  800638:	b8 33 10 80 00       	mov    $0x801033,%eax
