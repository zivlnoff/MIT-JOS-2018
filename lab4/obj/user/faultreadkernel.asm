	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001d4:	0f be 80 f1 0f 80 00 	movsbl 0x800ff1(%eax),%eax
  8001db:	50                   	push   %eax
...
00800228 <vprintfmt>:
{
  ...
  800274:	ff 24 85 c0 10 80 00 	jmp    *0x8010c0(,%eax,4)
  ...
  800340:	8b 14 85 20 12 80 00 	mov    0x801220(,%eax,4),%edx
  800347:	85 d2                	test   %edx,%edx
  800349:	74 18                	je     800363 <vprintfmt+0x13b>
				printfmt(putch, putdat, "%s", p);
  80034b:	52                   	push   %edx
  80034c:	68 12 10 80 00       	push   $0x801012
  800351:	53                   	push   %ebx
  800352:	56                   	push   %esi
  ...
  800363:	50                   	push   %eax
  800364:	68 09 10 80 00       	push   $0x801009
  800369:	53                   	push   %ebx
  80036a:	56                   	push   %esi
  ...
  80038b:	b8 02 10 80 00       	mov    $0x801002,%eax
...
sys_env_destroy(envid_t envid) {
  ...
  800b33:	68 44 12 80 00       	push   $0x801244
  800b38:	6a 24                	push   $0x24
  800b3a:	68 61 12 80 00       	push   $0x801261
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bb4:	68 44 12 80 00       	push   $0x801244
  800bb9:	6a 24                	push   $0x24
  800bbb:	68 61 12 80 00       	push   $0x801261
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bf6:	68 44 12 80 00       	push   $0x801244
  800bfb:	6a 24                	push   $0x24
  800bfd:	68 61 12 80 00       	push   $0x801261
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c38:	68 44 12 80 00       	push   $0x801244
  800c3d:	6a 24                	push   $0x24
  800c3f:	68 61 12 80 00       	push   $0x801261
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c7a:	68 44 12 80 00       	push   $0x801244
  800c7f:	6a 24                	push   $0x24
  800c81:	68 61 12 80 00       	push   $0x801261
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cbc:	68 44 12 80 00       	push   $0x801244
  800cc1:	6a 24                	push   $0x24
  800cc3:	68 61 12 80 00       	push   $0x801261
...
sys_ipc_recv(void *dstva)
{
  ...
  800d20:	68 44 12 80 00       	push   $0x801244
  800d25:	6a 24                	push   $0x24
  800d27:	68 61 12 80 00       	push   $0x801261
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d4d:	56                   	push   %esi
  800d4e:	50                   	push   %eax
  800d4f:	68 70 12 80 00       	push   $0x801270
  ...
  800d60:	e8 75 f3 ff ff       	call   8000da <vcprintf>
	cprintf("\n");
  800d65:	c7 04 24 94 12 80 00 	movl   $0x801294,(%esp)
