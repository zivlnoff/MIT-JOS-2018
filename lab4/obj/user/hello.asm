...
umain(int argc, char **argv)
{
  ...
  80003e:	e8 f8 00 00 00       	call   80013b <cprintf>
  ...
  800054:	e8 e2 00 00 00       	call   80013b <cprintf>
}
...
libmain(int argc, char **argv)
{
  ...
  800067:	8b 55 0c             	mov    0xc(%ebp),%edx
	...
	thisenv = envs;
  80006a:	c7 05 04 20 80 00 00 	movl   $0xeec00000,0x802004
  800071:	00 c0 ee 
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001e4:	0f be 80 0f 10 80 00 	movsbl 0x80100f(%eax),%eax
  8001eb:	50                   	push   %eax
...
00800238 <vprintfmt>:
{
  ...
  800284:	ff 24 85 e0 10 80 00 	jmp    *0x8010e0(,%eax,4)
  ...
  800350:	8b 14 85 40 12 80 00 	mov    0x801240(,%eax,4),%edx
  800357:	85 d2                	test   %edx,%edx
  800359:	74 18                	je     800373 <vprintfmt+0x13b>
				printfmt(putch, putdat, "%s", p);
  80035b:	52                   	push   %edx
  80035c:	68 30 10 80 00       	push   $0x801030
  800361:	53                   	push   %ebx
  800362:	56                   	push   %esi
  ...
  800373:	50                   	push   %eax
  800374:	68 27 10 80 00       	push   $0x801027
  800379:	53                   	push   %ebx
  80037a:	56                   	push   %esi
  ...
  80039b:	b8 20 10 80 00       	mov    $0x801020,%eax
...
sys_env_destroy(envid_t envid) {
  ...
  800b43:	68 64 12 80 00       	push   $0x801264
  800b48:	6a 24                	push   $0x24
  800b4a:	68 81 12 80 00       	push   $0x801281
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bc4:	68 64 12 80 00       	push   $0x801264
  800bc9:	6a 24                	push   $0x24
  800bcb:	68 81 12 80 00       	push   $0x801281
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c06:	68 64 12 80 00       	push   $0x801264
  800c0b:	6a 24                	push   $0x24
  800c0d:	68 81 12 80 00       	push   $0x801281
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c48:	68 64 12 80 00       	push   $0x801264
  800c4d:	6a 24                	push   $0x24
  800c4f:	68 81 12 80 00       	push   $0x801281
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c8a:	68 64 12 80 00       	push   $0x801264
  800c8f:	6a 24                	push   $0x24
  800c91:	68 81 12 80 00       	push   $0x801281
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ccc:	68 64 12 80 00       	push   $0x801264
  800cd1:	6a 24                	push   $0x24
  800cd3:	68 81 12 80 00       	push   $0x801281
...
sys_ipc_recv(void *dstva)
{
  ...
  800d30:	68 64 12 80 00       	push   $0x801264
  800d35:	6a 24                	push   $0x24
  800d37:	68 81 12 80 00       	push   $0x801281
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d5d:	56                   	push   %esi
  800d5e:	50                   	push   %eax
  800d5f:	68 90 12 80 00       	push   $0x801290
  ...
  800d70:	e8 75 f3 ff ff       	call   8000ea <vcprintf>
	cprintf("\n");
  800d75:	c7 04 24 ec 0f 80 00 	movl   $0x800fec,(%esp)
