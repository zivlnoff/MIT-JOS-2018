	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800241:	0f be 84 06 d4 ee ff 	movsbl -0x112c(%esi,%eax,1),%eax
  800248:	ff 
  800249:	50                   	push   %eax
...
00800296 <vprintfmt>:
{
  ...
  8002ef:	03 8c 83 64 ef ff ff 	add    -0x109c(%ebx,%eax,4),%ecx
...
008003a7 <.L32>:
  ...
  8003c4:	52                   	push   %edx
  8003c5:	8d 83 f5 ee ff ff    	lea    -0x110b(%ebx),%eax
  8003cb:	50                   	push   %eax
  8003cc:	56                   	push   %esi
  ...
  8003e0:	50                   	push   %eax
  8003e1:	8d 83 ec ee ff ff    	lea    -0x1114(%ebx),%eax
  8003e7:	50                   	push   %eax
  8003e8:	56                   	push   %esi
...
008003fc <.L36>:
  ...
  80040c:	8d 83 e5 ee ff ff    	lea    -0x111b(%ebx),%eax
...
sys_env_destroy(envid_t envid) {
  ...
  800bcf:	8d 83 bc f0 ff ff    	lea    -0xf44(%ebx),%eax
  800bd5:	50                   	push   %eax
  800bd6:	6a 24                	push   $0x24
  800bd8:	8d 83 d9 f0 ff ff    	lea    -0xf27(%ebx),%eax
  800bde:	50                   	push   %eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c34:	57                   	push   %edi
  800c35:	50                   	push   %eax
  800c36:	8d 83 e8 f0 ff ff    	lea    -0xf18(%ebx),%eax
  800c3c:	50                   	push   %eax
  ...
  800c49:	e8 ce f4 ff ff       	call   80011c <vcprintf>
	cprintf("\n");
  800c4e:	8d 83 c8 ee ff ff    	lea    -0x1138(%ebx),%eax
